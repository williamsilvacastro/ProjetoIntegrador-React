        ...
        <div className="boxFields" style={{ paddingTop: 20 }}>
            ...
            <tbody>
              <tr>
                ...
                <td rowSpan="2" className="tserie txt-center">
                  ...
                  <span>
                    Nº {notaFiscal.nf ? notaFiscal.nf.id_nf : ""}
                  </span>
                  <span>
                    Série {notaFiscal.nf ? notaFiscal.nf.serie : ""}
                  </span>
                </td>
              </tr>
              <tr>
            ...
            <tbody>
              <tr>
                    ...
                    <tbody>
                      <tr>
                        <td>
                          ...
                          <span className="info">
                            {notaFiscal.nf ? notaFiscal.nf.cliente.nome : ""}
                          </span>
                        </td>
                        <td style={{ width: "40mm" }}>
                          <span className="nf-label">CNPJ/CPF</span>
                          <span className="info">
                            {notaFiscal.nf ? notaFiscal.nf.cliente.cpf : ""}
                          </span>
                        </td>
                      </tr>
                    </tbody>
                ...
                <td style={{ width: "22mm" }}>
                  ...
                  <span className="info">
                    {new Date(notaFiscal.nf ? notaFiscal.nf.emissao : "").toLocaleDateString()}
                  </span>
                </td>
              </tr>
              <tr>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td style={{ width: "44mm" }}>
                          ...
                          <span className="info">
                            {notaFiscal.nf ? notaFiscal.nf.cliente.telefone : ""}
                          </span>
                        </td>
                        <td style={{ width: "28mm" }}>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    <span className="info">
                      {notaFiscal.nf ? notaFiscal.nf.total : ""}
                    </span>
                  </td>
                  <td>
          ...
          <div className="wrapper-border">
            ...
            >
              ...
              <tbody >
                {(notaFiscal.nf ? notaFiscal.item_nf : []).map((item) => (
                  <>
                    <tr className="titles">
                      ...
                      <th className="un">{item.quantidade_produto}</th>
                      <th className="amount">{item.quantidade_produto}</th>
                      <th className="valUnit">{item.valor_unitario}</th>
                      <th className="valTotal">{item.valor_total}</th>
